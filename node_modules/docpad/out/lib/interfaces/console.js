...
ConsoleInterface = (function() {
  ...
  function ConsoleInterface(opts, next) {
    var commander, consoleInterface, docpad, locale, version,
      _this = this;
    this.watch = function(next) {
      return ConsoleInterface.prototype.watch.apply(_this, arguments);
    };
    this.skeleton = function(next) {
      return ConsoleInterface.prototype.skeleton.apply(_this, arguments);
    };
    this.clean = function(next) {
      return ConsoleInterface.prototype.clean.apply(_this, arguments);
    };
    this.server = function(next) {
      return ConsoleInterface.prototype.server.apply(_this, arguments);
    };
    this.run = function(next) {
      return ConsoleInterface.prototype.run.apply(_this, arguments);
    };
    this.render = function(next, opts) {
      return ConsoleInterface.prototype.render.apply(_this, arguments);
    };
    this.install = function(next) {
      return ConsoleInterface.prototype.install.apply(_this, arguments);
    };
    this.info = function(next) {
      return ConsoleInterface.prototype.info.apply(_this, arguments);
    };
    this.help = function(next) {
      return ConsoleInterface.prototype.help.apply(_this, arguments);
    };
    this.generate = function(next) {
      return ConsoleInterface.prototype.generate.apply(_this, arguments);
    };
    this.action = function(next, opts) {
      return ConsoleInterface.prototype.action.apply(_this, arguments);
    };
    this.welcomeCallback = function(opts, next) {
      return ConsoleInterface.prototype.welcomeCallback.apply(_this, arguments);
    };
    this.selectSkeletonCallback = function(skeletonsCollection, next) {
      return ConsoleInterface.prototype.selectSkeletonCallback.apply(_this, arguments);
    };
    this.extractConfig = function(customConfig) {
      if (customConfig == null) {
        customConfig = {};
      }
      return ConsoleInterface.prototype.extractConfig.apply(_this, arguments);
    };
    this.completeAction = function(err) {
      return ConsoleInterface.prototype.completeAction.apply(_this, arguments);
    };
    this.performAction = function(action, args, config) {
      return ConsoleInterface.prototype.performAction.apply(_this, arguments);
    };
    this.handleError = function(err) {
      return ConsoleInterface.prototype.handleError.apply(_this, arguments);
    };
    this.getCommander = function() {
      return ConsoleInterface.prototype.getCommander.apply(_this, arguments);
    };
    this.start = function(argv) {
      return ConsoleInterface.prototype.start.apply(_this, arguments);
    };
