...
var Backbone, FileModel, Iconv, Model, balUtil, jschardet, mime, pathUtil, _ref,
...
FileModel = (function(_super) {
  ...
  FileModel.prototype.parse = function(opts, next) {
    var buffer, changes, content, encoding, fullPath, isText, source, _ref1, _ref2, _ref3;
    if (opts == null) {
      opts = {};
    }
    _ref1 = this.getActionArgs(opts, next), opts = _ref1.opts, next = _ref1.next;
    ...
    if ((encoding != null) === false || opts.reencode === true) {
      ...
      if (isText === true) {
        if (this.detectEncoding) {
          ...
          if (encoding == null) {
            encoding = ((_ref2 = jschardet.detect(buffer)) != null ? _ref2.encoding : void 0) || 'utf8';
          }
        } else {
          if (encoding == null) {
            encoding = 'utf8';
        ...
        if ((_ref3 = encoding.toLowerCase()) !== 'ascii' && _ref3 !== 'utf8' && _ref3 !== 'utf-8') {
          if (Iconv != null) {
