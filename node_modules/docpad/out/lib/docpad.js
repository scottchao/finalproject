  ...
  */
  ...
  function DocPad(instanceConfig, next) {
    var action, configEventContext, docpad, logger, _ref1,
      _this = this;
    this.server = function(opts, next) {
      return DocPad.prototype.server.apply(_this, arguments);
    };
    this.serverMiddleware500 = function(err, req, res, next) {
      return DocPad.prototype.serverMiddleware500.apply(_this, arguments);
    };
    this.serverMiddleware404 = function(req, res, next) {
      return DocPad.prototype.serverMiddleware404.apply(_this, arguments);
    };
    this.serverMiddlewareRouter = function(req, res, next) {
      return DocPad.prototype.serverMiddlewareRouter.apply(_this, arguments);
    };
    this.serveDocument = function(opts, next) {
      return DocPad.prototype.serveDocument.apply(_this, arguments);
    };
    this.skeleton = function(opts, next) {
      return DocPad.prototype.skeleton.apply(_this, arguments);
    };
    this.run = function(opts, next) {
      return DocPad.prototype.run.apply(_this, arguments);
    };
    this.watch = function(opts, next) {
      return DocPad.prototype.watch.apply(_this, arguments);
    };
    this.render = function(opts, next) {
      return DocPad.prototype.render.apply(_this, arguments);
    };
    this.generate = function(opts, next) {
      return DocPad.prototype.generate.apply(_this, arguments);
    };
    this.generatePostpare = function(opts, next) {
      return DocPad.prototype.generatePostpare.apply(_this, arguments);
    };
    this.generateRender = function(opts, next) {
      return DocPad.prototype.generateRender.apply(_this, arguments);
    };
    this.generateParse = function(opts, next) {
      return DocPad.prototype.generateParse.apply(_this, arguments);
    };
    this.generateClean = function(opts, next) {
      return DocPad.prototype.generateClean.apply(_this, arguments);
    };
    this.generateCheck = function(opts, next) {
      return DocPad.prototype.generateCheck.apply(_this, arguments);
    };
    this.generatePrepare = function(opts, next) {
      return DocPad.prototype.generatePrepare.apply(_this, arguments);
    };
    this.action = function(action, opts, next) {
      return DocPad.prototype.action.apply(_this, arguments);
    };
    this.ensureFileOrDocument = function(data, options) {
      if (data == null) {
        data = {};
      }
      if (options == null) {
      ...
      return DocPad.prototype.ensureFileOrDocument.apply(_this, arguments);
    };
    this.ensureDocument = function(data, options) {
      if (data == null) {
        data = {};
      }
      if (options == null) {
      ...
      return DocPad.prototype.ensureDocument.apply(_this, arguments);
    };
    this.ensureFile = function(data, options) {
      if (data == null) {
        data = {};
      }
      if (options == null) {
      ...
      return DocPad.prototype.ensureFile.apply(_this, arguments);
    };
    this.createDocument = function(data, options) {
      ...
      return DocPad.prototype.createDocument.apply(_this, arguments);
    };
    this.createFile = function(data, options) {
      if (data == null) {
        data = {};
      }
      if (options == null) {
      ...
      return DocPad.prototype.createFile.apply(_this, arguments);
    };
    this.notify = function(message, opts) {
      return DocPad.prototype.notify.apply(_this, arguments);
    };
    this.warn = function(message, err, next) {
      return DocPad.prototype.warn.apply(_this, arguments);
    };
    this.error = function(err, type, next) {
      if (type == null) {
        type = 'err';
      }
      return DocPad.prototype.error.apply(_this, arguments);
    };
    this.log = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return DocPad.prototype.log.apply(_this, arguments);
    };
    this.fatal = function(err) {
      return DocPad.prototype.fatal.apply(_this, arguments);
    };
    this.clean = function(opts, next) {
      return DocPad.prototype.clean.apply(_this, arguments);
    };
    this.install = function(opts, next) {
      return DocPad.prototype.install.apply(_this, arguments);
    };
    this.load = function(instanceConfig, next) {
      return DocPad.prototype.load.apply(_this, arguments);
    };
    this.setConfig = function(instanceConfig, next) {
      return DocPad.prototype.setConfig.apply(_this, arguments);
    };
    this.ready = function(opts, next) {
      return DocPad.prototype.ready.apply(_this, arguments);
    };
  ...
  DocPad.prototype.ready = function(opts, next) {
    var docpad, instanceConfig, locale, mixpanelInstance, pluginName, pluginsList, tasks, _ref1,
      _this = this;
    _ref1 = balUtil.extractOptsAndCallback(instanceConfig, next), instanceConfig = _ref1[0], next = _ref1[1];
    docpad = this;
    locale = this.getLocale();
